...
220 Vega differential fixtures and 332 Vega-Lite fixtures.
...
| --- | --- | --- | --- | --- |
| `a-scale-coerces-what-it-is-given` | 35 | rule, symbol, text | — | band, linear, quantile, quantize, threshold |
...
| `autosize-fit-signal-size` | 25 | rect, rule, text | — | band, linear |
...
| `guide-encode-datum` | 26 | rect, rule, text | — | band, linear |
...
| `negative-font-size` | 34 | rect, rule, symbol, text | — | band, linear, ordinal |
...
| `title-nudge` | 27 | rect, rule, text | — | band, linear |
| `title-orient-none` | 27 | rect, rule, text | — | band, linear |
...
| `zindex-sign` | 51 | rect, rule, text | — | band, linear |
