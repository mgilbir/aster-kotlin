 ...
 * `VegaChartController.diagnostics` rather than swallowing it (CONTRIBUTING.md).
 */
 ...
 * functions are looked up in a plain map, so what can run is exactly what [Functions] declares.
 *
