 ...
 * Milestone 4. Two rules are load-bearing and encoded here rather than left to the implementation:
 * - no `eval`, JavaScript, reflection-based dispatch or generated bytecode
 ...
 * lifetime is controllable (CONTRIBUTING.md).
 *
 ...
 * null, which is the part worth keeping — ADR 0011, never silently ignore what you cannot do.
 */
