...
dependencies {
  ...
  implementation("io.github.mgilbir.astervega:vega-runtime:0.4.0")
  // Vega-Lite in, Vega out. Only needed if the specifications are Vega-Lite.
  implementation("io.github.mgilbir.astervega:vega-lite:0.4.0")

  // One renderer, whichever suits the host:
  implementation("io.github.mgilbir.astervega:vega-android-canvas:0.4.0")        // Android View
  implementation("io.github.mgilbir.astervega:vega-compose:0.4.0")               // Jetpack Compose
  implementation("io.github.mgilbir.astervega:vega-compose-multiplatform:0.4.0") // Compose MP
}
```
...
```swift
// Package.swift
.package(url: "https://github.com/mgilbir/aster-kotlin", from: "0.4.0")
```
