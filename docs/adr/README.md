...
Amend a record rather than silently changing behaviour that contradicts it.
...
| [0003](0003-compose-hosts-the-view.md) | The Compose API hosts the canonical View |
