...
**124 of 627 matched exactly** at the start, and **574** do now.
...
The sweep has been the working list ever since, and the 53 that still differ cluster like this:
