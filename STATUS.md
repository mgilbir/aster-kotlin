...
**124 of 627 matched exactly** at the start, and **575** do now.
...
The sweep has been the working list ever since, and the 52 that still differ cluster like this:
