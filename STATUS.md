...
222 Vega differential fixtures and 332 Vega-Lite fixtures pass, every one of them matching upstream
...
| Diagnostics, canonical snapshots, goldens, oracle scaffolding | No upstream equivalent. Two differential oracles, one for Vega and one for Vega-Lite, with 222 Vega differential fixtures and 332 Vega-Lite fixtures |
...
| 9. At least 100 compatibility fixtures pass | **Yes** — 222 Vega differential fixtures |
...
the only one. 222 Vega fixtures pass.
...
JSON writer that prints a non-finite number as itself. 222 Vega fixtures.
...
Seven mutants die on the fixture. 222 Vega fixtures.
...
distinct values one label and the corpus has such axes. 222 Vega fixtures.
...
apart by characters rather than by an absence. Seven mutants die on it. 222 Vega fixtures.
...
Found by the value sweep on the day it was written. 222 Vega fixtures.
