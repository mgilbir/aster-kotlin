...
internal class Composite(
  ...
  fun handles(type: String): Boolean = type == "errorbar" || type == "errorband"
   ...
   */
  fun normalize(unit: VegaValue.Obj): List<VegaValue.Obj>? {
    val markDef =
    ...
    return parts.mapNotNull { part ->
      if (!enabled(markDef, part.name, type)) return@mapNotNull null
      obj {
        putAll(outer)
