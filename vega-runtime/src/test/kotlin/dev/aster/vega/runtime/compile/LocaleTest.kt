 ...
 * file, and a Dutch patient reading a chart of their own depression scores got English month
...
class LocaleTest {
  ...
  /** The PHQ-9 shape from the review: five weekly scores on a temporal axis. */
